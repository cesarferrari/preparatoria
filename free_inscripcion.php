  ...
  require('conexion.php');
         ...
         if(isset($_GET['txtID'])){
            $id=$_GET['txtID'];
              ...
              $edita=$base->prepare('select* from inscripcion_asignatura where id_insc ='.$id);
              $edita->execute(array());
         ...
         ?>
                ...
                <input type="text" name="id_insc"  value="<?php echo $user['id_insc']?>" >
                </div>
                <div class="form_box">
        ...
        if(isset($_GET['btn_edicion'])){
            ...
            $edicion=$base->prepare("update inscripcion_asignatura set estatus=:estatus
             where id_insc=:id_insc");
             
            $edicion->bindParam(':estatus',$estatus);
               $edicion->bindParam(':id_insc',$id_insc);
