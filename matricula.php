...
function incidence($f1,$f2){
    ...
    $sql[0]="select a.nombre,a.apellidoP,a.apellidoM,incidencia,fecha from incidencia_al inner join   
    ...
    $sql[1]=" select a.nombre,a.apellidoP,a.apellidoM,incidencia,fecha from incidencia_al inner join    
    ...
    fecha from incidencia_prof inner join profesor p on p.id_profesor=incidencia_prof.id_profesor
      ...
      $sql[2]="select p.nombre,p.apellidoP,p.apellidoM,incidencia, fecha from incidencia_prof inner join profesor p 
      ...
      incidencia_al.id_alumno  union all select s.nombre,s.apellidoP,s.apellidoM,incidencia,fecha from incidencia inner join
       ...
       $sql[5]="select id_incidencia,a.nombre,a.apellidoP,a.apellidoM,incidencia,fecha from incidencia_al inner join alumno a on a.id=       
       incidencia_al.id_alumno  where fecha between '$f1' and '$f2'  ;";
       $sql[6]="select id_incidencia,p.nombre,p.apellidoP,p.apellidoM,incidencia, fecha from incidencia_prof inner join profesor p on       
       p.id_profesor=incidencia_prof.id_profesor  where fecha between '$f1' and '$f2' ;";
    
       return $sql;
}
  function incidenceMatr($f1,$f2,$matr){
    $sql[0]=" select id_incidencia,a.nombre,a.apellidoP,a.apellidoM,incidencia,fecha from incidencia_al inner join alumno a on a.id=
    incidencia_al.id_alumno  where fecha between '$f1' and '$f2' and a.matricula='$matr' ;";
    $sql[1]="select id_incidencia,p.nombre,p.apellidoP,p.apellidoM,incidencia, fecha from incidencia_prof inner join profesor p on 
    p.id_profesor=incidencia_prof.id_profesor  where fecha between '$f1' and '$f2' and  p.matricula='$matr' ;";
    $sql[2]="select id_incidencia,s.nombre,s.apellidoP,s.apellidoM,incidencia,fecha from incidencia inner join servicios_escolares s on 
